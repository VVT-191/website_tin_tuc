...
<div class="col-md-12">
                ...
                <div class="card-header">
                    <a class="btn btn-block btn-danger ad_add" href="{{url('admin/page/list')}}" title="thêm">Quay lại</a>
                </div>
              ...
              <form role="form" action="{{url('admin/page/edit/'.$Page->RowID)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <select class="form-control" name="Status">
                        ...
                        <option value="1" @if($Page->Status == 1) selected="" @endif   >Trạng thái: Bật</option>
                        <option value="0" @if($Page->Status == 0) selected="" @endif   >Trạng thái: Tắt</option>
                  ...
                  <div class="form-group">
                    ...
                    @if($Page->Images != NULL)
                    <br/>
                    <img src="{{URL::asset('images/page/'.$Page->Images)}}" alt="Avatar"/>
                    @endif
